...
export default function CaseStudyHighlight({
  ...
  showTag = false,
  description = "Moonstack excels with meticulous attention to detail, creative problem-solving, and effective communication. Their innovative solutions significantly enhanced the user experience.",
  clutchLogo,
  testimonial = {
