...
export default function LatestPosts() {
  ...
  return (
    <div className="mt-[60px] rounded-[10px] bg-[#05140A] p-[20px]">
      ...
      <div className="">
        {posts.map((post) => (
          <article
            key={post.id}
            className="group mb-[20px] flex gap-[20px] overflow-hidden rounded-[10px]  text-white shadow-[0_8px_32px_rgba(0,0,0,0.35)] transition "
          >
            {/* IMAGE */}
            {post.image && (
              <div className="relative w-[30%]">
                <Link href={`/blogs/${post.slug}`}>
                  <Image
                    ...
                    width={200}
                    height={200}
                    className="h-[100%] w-[100%] rounded-[10px] object-cover object-center"
                  />
                </Link>
              </div>
            )}
            ...
            {/* CONTENT */}
            <div className="flex w-[calc(70%-20px)] flex-col justify-between p-2">
              <div>
