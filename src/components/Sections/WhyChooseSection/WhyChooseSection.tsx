...
const WhyChooseSection: React.FC<WhyChooseSectionProps> = ({
  ...
  return (
    <section className="container mx-auto items-center bg-[url('/assets/choose-bg-img.webp')] bg-cover bg-center px-4 py-12 sm:px-10 md:py-20">
      <div className="grid gap-12 lg:grid-cols-2">
        ...
        <div className="self-start lg:sticky lg:top-24">
          ...
          <Heading
            headingTag="p"
            className="primary-grey text-start"
            content={[{ text: description }]}
          />
        </div>

        <div className="scrollbar-hide flex max-h-[600px] flex-col gap-6 overflow-y-auto pr-2">
