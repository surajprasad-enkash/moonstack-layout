...
const ProvenProcess = () => {
    return (
        <>
            <div className="bg-black p-15 text-white flex">
                <div className="w-1/2">
                    <div className="poppins-semibold font-40">Our <span style={{ color: Colors.brand200 }}>Proven Process</span></div>
                    <div className="poppins-medium leading-[200%] mt-4 w-2/3 font-16">In today’s fast-moving digital world, creativity and innovation play a vital role in building meaningful solutions. A great design is not just about how it looks, but also about how it works and how users feel while interacting with it</div>
                </div>
                <div className="w-1/2">
                    <div className="mt-10 rounded-2xl border-b-1 border-green-500 p-10 justify-between grid bg-gradient-to-br from-green-500 via-black to-black-500">
