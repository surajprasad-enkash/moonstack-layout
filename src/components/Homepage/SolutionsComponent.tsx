        ...
        <>
            <div className="bg-black text-white">
                <div className="flex flex-col md:flex-row items-center justify-between p-10">
                    ...
                    <div className="w-full md:w-2/5 lg:w-2/5 xl:w-[50%] solutions-bg poppins-medium font-16 text-center md:text-left">
                ...
                <div className="flex flex-col md:flex-row p-8">
                    <div className="w-full md:w-1/4 lg:w-1/4 xl:w-1/2 p-10 pt-4 right-gradient-bdr">
