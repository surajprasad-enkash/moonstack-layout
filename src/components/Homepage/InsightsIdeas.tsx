        ...
        <>
            <div className="bg-black p-15 pt-25 text-white">
                <div className="w-full md:w-1/2 lg:w-1/2 xl:w-1/2 text-center justify-self-center">
                    <div className="poppins-semibold font-40">Insights <span className="bg-gradient-to-r from-[#25E8B1] via=[#60F90D] to-[#60F90D] text-transparent bg-clip-text">& Ideas</span></div>
