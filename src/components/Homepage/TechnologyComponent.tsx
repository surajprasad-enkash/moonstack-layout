        ...
        <>
            <div className="text-white bg-black p-15">
                <div className="flex justify-between">
                    <div className="w-[40%] poppins-semibold font-36">
                        Our Best Technology we have used in <span style={{ color: Colors.brand200 }}>our projects</span>
                    </div>
                    <div className="w-[40%] poppins-medium leading-[200%] font-16">We focus on scalability, security, and user-centric design, ensuring that every project is future-ready and tailored to client needs.</div>
                </div>
                <div className="mt-10 rounded-2xl border-t-2 border-green-500 p-10 justify-between flex items-center bg-gradient-to-br from-green-500 via-black to-black-500">
                    <div className="w-[40%]">
