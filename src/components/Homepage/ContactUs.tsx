        ...
        <>
            <div className="bg-black p-15 flex flex-col md:flex-row justify-between text-white">
                ...
                <div className="rounded-2xl p-10 justify-between bg-gradient-to-br from-[#177634] via-black to-black-500 w-full md:w-[45%] lg:w-[45%] xl:w-[45%]">
                    <div className="poppins-semibold font-22 mb-20">What Our Customers Say</div>
                    <Slider ref={sliderRef} {...settings}>
                        {reviewsArr.map((review) => (
                            <div>
                                <div className="poppins-regular leading-[200%] font-18">{review.desc}</div>
                                <div className="flex mt-10">
                                    <Image src={customer} alt="image" className="w-11 h-11 mr-3" />
                                    <div>
                                        <div className="poppins-medium font-16" style={{ color: Colors.brand200 }}>{review.name}</div>
