                ...
                <div className='main-bg'>
                    <div className='bg-gradient-to-r from-transparent via-black to-transparent w-1/2 p-4 py-20'>
                        ...
                        <div className='flex gap-8 mt-6'>
                            <button ref={refs.getStartedBtnRef} className="bg-gradient-to-r from-green-500 to-black-500 text-white poppins-semibold py-2 px-10 rounded-4xl font-16 cursor-pointer">
                                Get Started
                            </button>
