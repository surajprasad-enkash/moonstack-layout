...
const HomepageBanner = () => {
  ...
  return (
    <>
      <section className="main-bg bg-black">
        <video autoPlay loop muted>
          <source src="/assets/Home-hero-bg.mp4" type="video/mp4" />
        </video>
        <div className="container mx-auto">
          <div className="">
            <div className="w-1/2 p-4 py-20 pt-36">
              ...
              <div className="poppins-medium font-14 mt-4 leading-[200%] text-white">
                ...
                Moonstack is one of the most experienced and reliable app and
                web development agencies in India. Skyrocket your business
                growth with Moonstack today!
              </div>
