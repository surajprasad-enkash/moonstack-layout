            ...
            <div className='bg-black'>
                <div className='main-bg'>
                    <div className='bg-gradient-to-r from-transparent via-black to-transparent w-1/2 p-4 py-20'>
                        ...
                        <div className='poppins-semibold text-white' style={{ fontSize: 50 }}>We Boost the Growth For Startup to <span style={{ color: Colors.brand200 }}>fortune 500</span> companies</div>
                        ...
                        <div className='flex gap-8'>
                            <button className="bg-gradient-to-r from-green-500 to-black-500 text-white poppins-semibold py-2 px-10 rounded-3xl mt-6 font-16">
                                Get Started
                            </button>
                            <button className="bg-black text-white poppins-semibold py-2 px-10 rounded-3xl mt-6 border-2 border-white-500 border-solid font-16">
                                Learn More
                            </button>
                        </div>
                    </div>
