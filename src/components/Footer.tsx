  ...
  return (
    <footer className="footer">
      <div className="pageFooter">
            ...
            <div className="row flex flex-wrap">
              ...
              <div className="footerLinksWrapper w-[100%] md:w-[50%]">
                <div className="flex w-[100%] flex-wrap">
                  ...
                  <div className="footerLinks w-[100%] md:w-[33.33%]">
                    ...
                    <ul className="footerMenu">
                      <li>
                        <Link href="/website-development-service">Web development</Link>
                      </li>
                      <li>
                        <Link href="/application-development">App development</Link>
                      </li>
                      <li>
              ...
              <div className="footerSocial flex w-[100%] flex-wrap items-center pt-[68px]">
                ...
                <div className="footerSocialRight flex justify-end gap-[20px] md:w-[50%]">
                  <Link target="_blank" href="https://www.facebook.com/people/Moonstack/100085468621969/?_rdr" aria-label="Facebook">
                    <Image src={facebook} alt="Facebook" />
                  </Link>
                  <Link target="_blank" href="https://www.linkedin.com/company/moonstack-co/" aria-label="LinkedIn">
                    <Image src={linkedin} alt="LinkedIn" />
                  </Link>
                  <Link target="_blank" href="https://x.com/at_moonstack" aria-label="Twitter">
                    <Image src={twitter} alt="Twitter" />
                  </Link>
                  <Link target="_blank" href="https://www.instagram.com/moonstack.co/?utm_source=ig_web_button_share_sheet&igshid=OGQ5ZDc2ODk2ZA%3D%3D" aria-label="Instagram">
        ...
        <div className="footerBrandText px-[20px] md:px-20 pt-15 pb-12">
          <div className="container">
          ...
          {/* BOTTOM */}
          <div className="footerBottom text-center mt-[50px]">
            <p>
