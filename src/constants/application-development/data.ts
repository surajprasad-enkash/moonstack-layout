...
import androidBannerBg from "@/assets/app-development-images/app-hire-banner.webp";
...
import androidContactbannerBg from "@/assets/app-development-images/contact-app-bg.webp";
import iosContactbannerBg from "@/assets/app-development-images/ios-contact-img.webp";
import nativeContactbannerImg from "@/assets/app-development-images/react-native-contact-img.webp";
import nativeContactbannerBg from "@/assets/app-development-images/react-native-contact-bg.webp";
import maintenanceContactbannerImg from "@/assets/app-development-images/maintanance-contact-img.webp";
import maintenanceContactbannerBg from "@/assets/app-development-images/maintanance-contact-bg.webp";
import androidTabOne from "@/assets/app-development-images/android-tab-img-one.webp";
import androidTabTwo from "@/assets/app-development-images/android-tab-img-two.webp";
import androidTabThree from "@/assets/app-development-images/android-tab-img-three.webp";
import androidTabFour from "@/assets/app-development-images/android-tab-img-four.webp";
import androidTabFive from "@/assets/app-development-images/android-tab-img-five.webp";
import androidTabSix from "@/assets/app-development-images/android-tab-img-six.webp";

import iosTabOne from "@/assets/app-development-images/ios-tab-img-one.webp";
import iosTabTwo from "@/assets/app-development-images/ios-tab-img-two.webp";
import iosTabThree from "@/assets/app-development-images/ios-tab-img-three.webp";
import iosTabFour from "@/assets/app-development-images/ios-tab-img-four.webp";
import iosTabFive from "@/assets/app-development-images/ios-tab-img-five.webp";

import nativeTabOne from "@/assets/app-development-images/native-tab-img-one.webp";
import nativeTabTwo from "@/assets/app-development-images/nativeTabTwo.webp";
import nativeTabThree from "@/assets/app-development-images/nativeTabThree.webp";
import nativeTabFour from "@/assets/app-development-images/nativeTabFour.webp";
import nativeTabFive from "@/assets/app-development-images/nativeTabFive.webp";
import nativeTabSix from "@/assets/app-development-images/nativeTabSix.webp";

import pwaTabOne from "@/assets/app-development-images/pwaTabOne.webp";
import pwaTabTwo from "@/assets/app-development-images/pwaTabTwo.webp";
import pwaTabThree from "@/assets/app-development-images/pwaTabThree.webp";
import pwaTabFour from "@/assets/app-development-images/pwaTabFour.webp";
import pwaTabFive from "@/assets/app-development-images/pwaTabFive.webp";
import pwaTabSix from "@/assets/app-development-images/pwaTabSix.webp";

import manTabOne from "@/assets/app-development-images/manTabOne.webp";
import manTabTwo from "@/assets/app-development-images/manTabTwo.webp";
import manTabThree from "@/assets/app-development-images/manTabThree.webp";
import manTabFour from "@/assets/app-development-images/manTabFour.webp";
import manTabFive from "@/assets/app-development-images/manTabFive.webp";
import manTabSix from "@/assets/app-development-images/manTabSix.webp";

import androidImportanceImg from "@/assets/app-development-images/android-importance-img.webp";
import iosImportanceImg from "@/assets/app-development-images/ios-importance-img.webp";
import nativeImportanceImg from "@/assets/app-development-images/react-importance-img.webp";
import maintenenceImportanceImg from "@/assets/app-development-images/maintance-importance-img.webp";
import pwaImportanceImg from "@/assets/app-development-images/pwa-importance-img.webp";
...
export const pagesData: Record<
  string,
  {
    ...
    importanceImg: StaticImageData | string;
...
> = {
  "android-app": {
    ...
    importanceImg: androidImportanceImg,
    points:
    ...
    solutions: {
      headingText:
        "Discover how efficient Android App Developer company can affect your product",
      subHeadingText: "",
    },
    featuresData: [
      {
    ...
    processSteps: {
      headingText:
        "Our Application development  process wraps around your unique business needs",
      subHeadingText:
  ...
  "iOS-app": {
    ...
    importanceImg: iosImportanceImg,
    points:
    ...
    highlightText: "iOS application development service in India",
    solutions: {
      headingText: "How our IOS Audit agency solves these issues",
      subHeadingText:
    ...
    processSteps: {
      headingText: "Our IOS service wraps around your unique business goals",
      subHeadingText:
  ...
  pwa: {
    ...
    importanceImg: pwaImportanceImg,
    points:
  ...
  "app-maintenance": {
    ...
    importanceImg: maintenenceImportanceImg,
    solutions: {
      headingText: "Our Specialities",
      subHeadingText:
...
export const mobileDesignFeatures = [
  {
    icon: intuitiveIcon,
    title: "Intuitive and clear mobile design",
    description:
      "Our mobile design approach prioritizes intuitive layouts, clear navigation, and accessible functionality to keep users engaged.",
  },
  {
    icon: engagingIcon,
    title: "Engaging app user experience",
    description:
      "Our mobile UI/UX design services keep users engaged and captivated, leading to higher retention and memorable experiences.",
  },
  {
    icon: brandingIcon,
    title: "App design that reflects your brand",
    description:
      "We design mobile applications that strengthen recognition and trust, turning your brand into a powerful digital presence.",
  },
];

export const mobileDesignProcess = [
  {
    stage: "STAGE 1",
    title: "Discovery & UX research",
    gradient: "bg-emerald-400 text-black",
    items: [
      { label: "Briefing & onboarding" },
      { label: "Product/business goals" },
      { label: "Product testing" },
      { label: "Competitor’s research" },
  ...
  },
  {
    stage: "STAGE 2",
    title: "UX Design",
    gradient: "bg-cyan-400 text-black",
    items: [{ label: "Wireframes" }, { label: "Prototyping" }],
  },
  {
    stage: "STAGE 3",
    title: "UI Design",
    gradient: "bg-blue-500 text-white",
    items: [
      { label: "Moodboard" },
  ...
  },
  {
    ...
    gradient: "bg-purple-500 text-white",
    items: [{ label: "Team extension for design improvements" }],
  },
];
