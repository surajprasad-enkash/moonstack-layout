...
import sol3 from "@/assets/sol3.svg";
import SliderOne from "@/assets/sliderOne.webp";
import SliderTwo from "@/assets/sliderTwo.webp";
import SliderThree from "@/assets/SliderThree.webp";
import SliderFour from "@/assets/sliderFour.webp";
import SliderFive from "@/assets/SliderFive.webp";
import html from "@/assets/htmlWithoutBg.svg";
...
import cakePhpIcon from "@/assets/cake-php-icon.svg";
import laravelIcon from "@/assets/laravel-icon.svg";
import codeIgniteIcon from "@/assets/codeIgnite-icon.svg";
import cssIcon from "@/assets/css-icon.svg";
import dockerIcon from "@/assets/docker-icon.svg";
import kubernetesIcon from "@/assets/kubernetes-icon.svg";
import azureIcon from "@/assets/azure-kubernetes-service.svg";
import cloudIcon from "@/assets/cloud-icon.svg";
import microsoftIcon from "@/assets/microsoft-azure-icon.svg";
import adobeIcon from "@/assets/adobe-xd.svg";
import illustatorIcon from "@/assets/iullustrator.svg";
...
import googleAnalyticsIcon from "@/assets/google-analytics-icon.svg";
import ahrefsIcon from "@/assets/ahrefs-icon.svg";
import mozIcon from "@/assets/moz-icon.svg";
import ubersuggestIcon from "@/assets/ubersuggest-icon.svg";
import grammerlyIcon from "@/assets/grammerly-icon.svg";
import woorankIcon from "@/assets/woorank-icon.svg";
...
import serviceIconOne from "@/assets/ios-green-icon.svg";
import serviceIconTwo from "@/assets/android-green-icon.svg";
import serviceIconThree from "@/assets/mobile-green-icon.svg";
import serviceIconFour from "@/assets/react-green-icon.svg";
import serviceIconFive from "@/assets/pwa-green-icon.svg";
import serviceIconSix from "@/assets/maintanance-green-icon.svg";
import featureIconOne from "@/assets/app-development-images/why-choose-icon-one.svg";
import featureIconTwo from "@/assets/app-development-images/why-choose-icon-two.svg";
import featureIconThree from "@/assets/app-development-images/why-choose-icon-three.svg";
import featureIconFour from "@/assets/app-development-images/why-choose-icon-four.svg";
import featureIconFive from "@/assets/app-development-images/why-choose-icon-five.svg";

import tabImg from "@/assets/app-development-images/tab-img.webp";
...
export const accordionData: FAQItem[] = [
  {
  ...
  },
  {
    ...
    answer:
      "Yes, we have experience building commercial apps with full payment gateway integration and e-commerce functionality.",
  },
  {
    question: "Can I hire developers from Moonstack to join my in-house team?",
    answer:
      "Yes, with our liaison program, clients can contractually hire our developers for in-house projects.",
  },
];
