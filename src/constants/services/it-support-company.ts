...
export const it_support: PageData = {
  hero: {
    title: [
      {
        text: " Supporting India and USA businesses with ",
        color: "text-white",
      },
      {
  ...
  seo: {
    ...
    keywords:
      "IT support services India 2026, managed IT support company India,  affordable IT helpdesk services India,remote IT support for businesses India, IT infrastructure support India, 24/7 IT support providers India",
    canonical: "https://www.moonstack.com/services/it-support-company",
