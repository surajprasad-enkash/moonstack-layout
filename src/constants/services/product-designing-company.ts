...
export const product: PageData = {
  hero: {
    title: [
      {
        text: "  Transforming Ideas into Reality with ",
        color: "text-white",
      },
      {
        text: "Moonstack's Custom Product Design Services",
        color: "text-white",
      },
    ],
    description: [
    ...
    breadcrumbs: [
      ...
      {
        label: "Product designing company",
        href: "/service/product-designing-company",
      },
    ],
  },
  seo: {
    ...
    keywords:
      "product design company India 2026, affordable product design services India,  best product design firms India,innovative product designing solutions India",
    canonical: "https://www.moonstack.com/services/product-designing-company",
