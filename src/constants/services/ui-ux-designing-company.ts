...
export const ui_ux: PageData = {
  hero: {
    title: [
      {
        text: "  Transform Your Digital Presence with",
        color: "text-white",
      },
      {
        text: "  Moonstack’s UI/UX Design Services",
        color: "text-white",
      },
    ],
    description: [
  ...
  seo: {
    ...
    keywords:
      "UI UX design company India 2026, best UI UX design agency India,  Custom Android application development India,Android app development agency India",
    canonical:
