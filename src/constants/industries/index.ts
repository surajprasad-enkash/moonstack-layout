...
import bccKristenCheng2 from "@/assets/clientsImages/admissifyceo.webp"
import bccKristenCheng3 from "@/assets/clientsImages/amitnuvama.webp"
import bccKristenCheng4 from "@/assets/clientsImages/authbridge.webp"
import bccKristenCheng5 from "@/assets/clientsImages/brainmates.webp"
import bccKristenCheng6 from "@/assets/clientsImages/coralogixceo.webp"
import bccKristenCheng7 from "@/assets/clientsImages/manshi.webp"
...
export const appCategoryBannerData = {
  title: [
    {
...
export const testimonialCardData = {
  quote:
    "The Moonstack team is highly professional, responsive, and reliable. From planning to execution, everything was handled smoothly. Their ability to meet deadlines while maintaining high-quality standards makes them a trusted long-term partner for us.",
...
export const aiProductsGridData = {
  heading: [
    {
  ...
  items: [
    ...
    },
    {
      ...
      Icon: Icon2,
      href: "/contact-us",
      gradient: "linear-gradient(91deg, #80cab6 -61.77%, #FFF 87.06%), #1C1C1C",
    },
    {
      title: "E-commerce",
      description:
...
export const businessNeedsDesignSectionData = {
  heading: [
    { text: "Why Choose " },
  ...
  subheading:
    "Moonstack is a leader in app development services providers, offering customized mobile applications and websites that cater to the specific needs of your industries. Our applications are designed to enhance operational efficiency, improve customer engagement, and drive business growth across various sectors.",
  leftCards: [],
}
...
export const aiExperienceData = {
  ...
  description:
    "Our expert team combines industry knowledge with innovative technology to deliver solutions that drive business growth and enhance customer satisfaction. Contact us today to learn how our innovative solutions can transform your business operations and help you stay ahead in a competitive market.",
  items: [
    {
      image: img1,
    },
...
export const industryExperienceData = {
  heading: [
  ...
  description:
    "Having launched successful products across various sectors, our team knows how to drive ROI through design. We combine industry-best practices with tailored strategies to ensure your digital product stands out in its market.",
  industries: [
    {
...
export const projectCtaBgData = projectCtaBg.src
