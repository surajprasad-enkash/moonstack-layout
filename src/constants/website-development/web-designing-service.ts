    ...
    steps: [
      {
        ...
        description:
          "Our first step is to collect complete information about the project, giving us a clear understanding of the client's needs and expectations.",
      },
      {
        id: 2,
        ...
        description:
          "We analyze market needs, study competitor strategies, and create a structured plan that aligns with the project’s goals.",
      },
      {
        id: 3,
        ...
        description:
          "Our team designs intuitive wireframes and strong structural layouts that ensure user-friendly navigation and an engaging interface.",
      },
      {
        id: 4,
        ...
        description:
          "We craft interactive, visually appealing, and responsive UI/UX designs that enhance user engagement and deliver an exceptional digital experience.",
      },
      {
        id: 5,
        ...
        description:
          "Our web design team rigorously tests all functionalities to ensure a flawless, smooth, and high-performing user experience.",
      },
      {
        id: 6,
        ...
        description:
          "After deployment, we provide ongoing support and regular updates based on the latest trends to keep your design modern and effective.",
      },
    ],
  },
  ...
  accordionData: [
    {
      ...
      desc: "We offer a complete range of web designing services including custom website design, responsive layouts, UI/UX designing, landing page design, website redesign, and consulting services tailored to meet modern business needs.",
    },
    {
      title: "Do you provide responsive web design for all devices?",
      desc: "Yes, all our web designs are fully responsive and optimized for mobile, tablet, and desktop devices. We ensure seamless performance and accessibility across every screen size.",
    },
    {
      title: "Can you redesign an existing website?",
      desc: "Absolutely. Our redesigning services help modernize outdated websites with fresh UI/UX, improved navigation, faster loading speed, and additional functionalities that align with your current brand identity.",
    },
    {
      title: "How important is UI/UX design for my website?",
      desc: "UI/UX plays a major role in customer retention and conversions. Our designers focus on creating visually appealing, user-friendly, and engaging interfaces that provide next-generation experiences to users.",
    },
    {
      title: "Do you provide SEO-friendly web design services?",
      desc: "Yes, we ensure every design is SEO-optimized with lightweight structure, fast loading speed, and search-friendly hierarchy to help your website rank higher and attract more users.",
    },
    {
      title:
        "Do you offer support and maintenance after designing the website?",
      desc: "Yes, we provide ongoing support and maintenance after deployment. This includes regular updates, design optimizations, and resolving any issues to ensure your website remains flawless and up-to-date.",
    },
  ],
};
