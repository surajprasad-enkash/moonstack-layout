...
export const wordPress: PageData = {
  ...
  solutions: {
    headingContent:
      "Our End to End Custom WordPress Development Service in India",
    subHeadingText:
  ...
  banner: {
    headingText: [
      {
        text: "Let’s talk about your WordPress needs ",
        color: "text-white",
      },
    ],
  ...
  accordionData: [
    {
      title: "How long will you take to deliver WordPress websites?",
      desc: "There is no fixed timeline for delivering WordPress websites, as it depends on project complexity, features, hiring model, and overall scope. On average, a custom WordPress website takes around two weeks, but the time may vary depending on specific requirements.",
    },
    {
      title: "Will you provide source code for WordPress development?",
      desc: "Yes, we provide complete source code after the development is finished. Your developers can easily edit, modify, add, or remove features as needed in the future. The entire codebase is handed over to you after project completion.",
    },
    {
      title: "Will my WordPress website be mobile friendly?",
      desc: "Absolutely. We ensure your WordPress website is fully responsive and mobile friendly across all devices including desktop, mobile, and tablets. Our developers follow best practices to deliver seamless, device-compatible experiences.",
    },
    {
      title:
        "Do you offer support and maintenance services after delivering the website?",
      desc: "Yes, we offer complete post-launch support and maintenance services. Our team remains available to fix bugs, optimise performance, and update your WordPress solution according to the latest market standards.",
    },
    {
      title: "Will my project details be secure with you?",
      desc: "Yes, your project and personal details are completely secure with us. We follow strict confidentiality practices and sign NDAs with clients as well as developers to ensure your data is never shared with any third party.",
    },
    {
      title: "What tips and tricks do you use for WordPress website security?",
      desc: "Our experienced WordPress developers follow best coding practices and implement strong security measures including firewalls, malware protection, regular backups, timely updates, and continuous monitoring to keep your website fully safe.",
    },
  ],
};
