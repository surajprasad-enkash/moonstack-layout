...
import bannerImg from "../../../../../public/assets/website-development-images/laravel-banner.webp";
  ...
  accordionData: [
    {
      ...
      desc: "Yes, our Laravel web developers are always available and they are proficient with all types of Laravel web development requirements. Our team offers professional Laravel web development services to our customers.",
    },
    {
      title: "How long will you take to build my Laravel website?",
      desc: "There is no fixed time - the completion of Laravel websites depends on various factors such as project complexity, timeline, number of Laravel developers, and scope. However, we ensure maximum effort and deliver solutions with all essential features.",
    },
    {
      title: "Will you provide Laravel migration services in India?",
      desc: "Yes, we provide Laravel migration services in India. Our expert Laravel team specializes in migrating solutions from other technologies to Laravel without affecting design, UI, performance, or data.",
    },
    {
      title: "Can I hire Laravel web developers from your team?",
      desc: "Yes, you can hire the best Laravel developers from our team on full time, part time, or hourly basis. We have a dedicated pool of experienced Laravel engineers available.",
    },
    {
      title:
        "Can you integrate API or third party services into my Laravel solutions?",
      desc: "Yes, we can enhance your Laravel solutions with third-party integrations via APIs. Our experts have hands-on experience with various external service integrations.",
    },
    {
      title: "How much does it cost for Laravel web development services?",
      desc: "There is no fixed cost for Laravel web development services. The final cost depends on multiple factors such as features, design, hiring model, integrations, and project requirements.",
    },
  ],
};
