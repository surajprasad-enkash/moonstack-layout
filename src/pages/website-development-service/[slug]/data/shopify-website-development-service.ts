...
export const shopify: PageData = {
  ...
  processSteps: {
    headingText:
      "Process we follow to deliver best Shopify Development Services in India? ",
    subHeadingText:
    ...
    steps: [
      ...
      {
        id: 2,
        title: "Planning to optimise store ",
        description:
  ...
  accordionData: [
    {
      title: "What services do you offer for Shopify development?",
      desc: "We provide end-to-end Shopify development services from consulting to launch and maintenance. Our services include custom theme development, store setup, app integration, UI/UX design, advanced functionalities, performance optimization, and ongoing support.",
    },
    {
      title: "How long will it take to build a Shopify store?",
      desc: "It typically takes around 2 weeks to set up a Shopify store. However, the timeline may vary depending on project requirements, hiring model, and the complexity of features needed.",
    },
    {
      title: "Will my Shopify store be mobile friendly?",
      desc: "Yes, your Shopify store will be fully mobile-friendly and responsive across all devices, ensuring the best user experience.",
    },
    {
      title: "Will you offer post launch support?",
      desc: "Yes, we provide ongoing support and maintenance after launch. As your long-term partner, we ensure continuous updates, improvements, and assistance whenever needed.",
    },
    {
      title: "Can you integrate third-party services in Shopify solutions?",
      desc: "Yes, we can integrate third-party services in Shopify stores and mobile apps using secure APIs, ensuring seamless functionality and performance.",
    },
    {
      title: "Will you be able to do Shopify migration?",
      desc: "Yes, our team is proficient in Shopify migration. We ensure 100% secure migration without data loss by following best industry practices throughout the process.",
    },
  ],
};
